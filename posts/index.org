...
Or maybe elisp would be closer to C, because that what it's base functions are written in. But even that is a bit different:
...
So, elisp is unlike any other language I know. Weird. And good to be aware of.
