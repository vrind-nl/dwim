...
the behavior of their users, and [[https://en.wikipedia.org/wiki/With_great_power_comes_great_responsibility][with great responsibility comes great power]]
(sic). The result could be that Google [[https://irreal.org/blog/?p=9837][controls]] what information
