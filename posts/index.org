...
Despite my [[file:2022-06-08-18-51-new-laptop-arrived.html][misgivings]] about Hyper-V itself, I was pleasantly surprised that WSL now included [[FILE:2022-06-13-11-58-WSL-GUI.HTML][graphical abilities]]. It also turned out that Docker used WSL, which in retrospect was a sign of what was to come.
...
My [[file:2022-04-29-13-49-new-laptop.html][new laptop]] arrived 'early' (May 31 instead of Jun 21: good marketing by Dell). These are my experiences so far with my intention to work under Windows instead of Ubuntu.
...
My laptop has 16GB RAM and 512GB SSD storage. I ran Windows 10 and Ubuntu in dual-boot mode for years, but switching back-and-forth drove me crazy, so about a year ago I started using [[file:2020-05-29-19-23-windows-on-linux.html][Windows on Linux]] in a virtual machine.
...
It has been almost a [[FILE:2020-03-23-08-20-COVID-19.HTML][year]] since my first post on COVID-19. And I am starting to suffer from a mild form of the Corona Blues:
...
[[File:2020-03-08-20-03-Virtual-Machine-Management.Html][Recently]] I rediscovered Qemu, which rekindled my interest in virtual machines (which I had sort of written off since my switch from Vagrant to Docker). But from Apple users I heard of [[https://www.parallels.com/][Parallels]] and how conveniently it merged the MacOS and Windows environments, so I started considering getting a MacBook. But I didn't want to give up on Linux just yet.
...
PS2: In my [[file:2020-04-16-10-14-covid-19-end-game.html][previous post]] I have indicated what I think we /should/ do.
...
- I am [[file:2020-03-23-08-20-covid-19.html][still]] not convinced that COVID-19 is significantly worse than the common flu. What I think we /can/ all agree on, is that COVID-19 is /new/, which means nobody had any immunity against it. I can't help but wonder if that is sufficient to explain the current pandemic.
...
In my previous post on [[file:2020-03-23-08-20-covid-19.html][COVID-19]] I predicted that mid April we would be past the worst in the Netherlands. This post is an update.
