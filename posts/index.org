...
I actually am proud of our household: so far, we have managed to keep our spirits up and avoided serious conflicts. Nut to be honest, others are (far) worse off than I am:
...
* PUBLISHED Windows on Linux                                     :tech:sysop:
...
[[Virtual Machine Management][Recently]] I rediscovered Qemu, which rekindled my interest in virtual machines (which I had sort of written off since my switch from Vagrant to Docker). But from Apple users I heard of [[https://www.parallels.com/][Parallels]] and how conveniently it merged the MacOS and Windows environments, so I started considering getting a MacBook. But I didn't want to give up on Linux yet.
