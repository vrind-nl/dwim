...
* DRAFT I know best, and you're doing it wrong!                     :society:

Do I have your attention? Good!

The title above is /not/ my view on things, but it /is/ how I perceive the attitude of some during this COVID-19 pandemic.

Here in The Netherlands we have our [[https://www.rijksoverheid.nl/onderwerpen/coronavirus-covid-19/veelgestelde-vragen-over-de-aanpak-van-het-nieuwe-coronavirus-in-nederland][official guidelines]], which boil down to:
- stay at home if possible
- keep 1.5m (6ft, 2 arm lengths) apart from each other
- regularly wash your hands

This approach has been called 'intelligent lock-down': instead of forcing everybody indoors, we trust the common sense of our citizens. But to make intelligent decisions, we need knowledge, and I feel like many try to compensate a [[https://www.who.int/emergencies/diseases/novel-coronavirus-2019/advice-for-public/myth-busters][lack of knowledge]] by erring on the side of caution. In other words, I feel like they overdo it. Not because I think caution is a bad thing, but because I expect we will have to endure this for some time to come, so we need to be practical about it. But more on that later.

As I understand it, the virus [[https://www.cdc.gov/coronavirus/2019-ncov/prevent-getting-sick/how-covid-spreads.html][spreads]] person-to-person through respiratory droplets, mostly by air (e.g. through sneezing), and also through objects we touch (my face → my hands → object → your hands → your face). Hence the social distancing.

What I derive from this:
- Intimate places like bars, (movie) theaters, and gyms are a perfect breading ground for this virus. Parks and beaches not so much, as long as you keep the 1.5m distance.
- Rubber gloves don't work. It just changes the contamination chain to: my face → my glove → object → your glove → your face. You can only break this chain by not touching your face (so much).
- Face masks help to prevent you contaminating others, because you can't touch your face as easily and it contains your sneezes. But they don't save you from becoming infected, unless you use them [[https://www.who.int/emergencies/diseases/novel-coronavirus-2019/advice-for-public/when-and-how-to-use-masks][properly]], which is so hard you probably won't. So save masks for the sick and the professionals.
- The 1.5m distance is important, but the risk of e.g. passing each other in the aisle of the grocery store is minimal, as long as you don't kiss each other (tempting, I know) and don't sneeze. Just don't hang around.

But what I see is:
- Closed parks and beaches. Which I get, because getting too close when you're having a good time is just too tempting.
- Parents not allowing their kids out of the house.
- Rubber gloves and face masks.
- One-way aisles, turning the grocery store into a maze, and people running the other way when they see me coming or giving me angry looks because I forgot something and had to go back.
- People touching the fresh produce to feel how ripe they are.

My gut-feeling is that the official guidelines are fine, and we need to relax a little on all the extra's we come up with. They may do more harm than good:
- This is going to take longer than anyone of us will be comfortable with. So we need to allow each other some space. I fear that in a couple of weeks the [[https://www.youtube.com/watch?v=pLu07aXTEKY][holier than thou]] types and the /this doesn't concern me/ types will have grown so far apart, that conflicts become inevitable.
- Our society needs to get back to normal soon, and we need to find other ways than a lock-down to deal with this pandemic. The IC personel can't keep this up for more than a couple of months, locked-up people go mad, and we need to have a healthy economy to pay for all this.

Some alternatives to lock-down:
- a [[https://fee.org/articles/an-alternative-to-the-lockdown-strategy-in-the-fight-against-coronavirus/][Market-Oriented Strategy]]?


* PUBLISHED When will we turn?                                      :society:
