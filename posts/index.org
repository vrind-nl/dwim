...
Headinds mark the beginning of a section. Within those sections can be metadata, text or further subtrees. The metadata is a whole new topic, so for now we will stick with text. The basic mark up of text looks like this:
...
The [[https://en.wikipedia.org/wiki/Peter_principle][Peter Principle]]
states:
...
It boils down to this: when you are competent at your job, you are
promoted until you're /not/ competent anymore.

I think something similar holds for software development. We increase
the ambition of our software projects until we're no longer comfortable
to build it.
