...
* PUBLISHED Subdocuments in Mongodb                                :mongo:js:
...
So far, my attempts to use Mongo failed, due to my inability to overcome the learning curve. In this post I will discuss one of my the biggest hurdles: subdocuments and many-to-many-relationships.
